...
class BacktestingEngine(object):
    ...
    def calculateBacktestingResult(self):
        ...
        myears = (self.dataEndDate - self.dataStartDate).days/365.0
        annualInterestRate = capital/self.capital/myears
        # 返回回测结果
        d = {}
        d['capital'] = capital
        ...
        d['drawdownListRate'] = drawdownListRate
        ...
        d['annualInterestRate'] = annualInterestRate
