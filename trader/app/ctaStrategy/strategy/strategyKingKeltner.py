...
class KkStrategy(CtaTemplate):
    ...
    def __init__(self, ctaEngine, setting):
        ...
        if setting.has_key("kkLength"):
            self.kkLength = setting["kkLength"]           # 计算通道中值的窗口数
        if setting.has_key("kkDev"):
            self.kkDev = setting["kkDev"]           # 计算通道中值的窗口数
        if setting.has_key("trailingPrcnt"):
            self.trailingPrcnt = setting["trailingPrcnt"]           # 计算通道中值的窗口数        
